...
public class ImagePickerActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private static SelectedImageAdapter imagesAdapter;
    ...
    private void setUpGridView() {
        imagesAdapter = new SelectedImageAdapter(ImagePickerActivity.this, galleryImageUrls, true);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.selectImagesBtn:
                ...
                intent.putExtra(NewEventActivity.CustomGalleryIntentKey, selectedItems.toString());//Convert Array into string to pass data
